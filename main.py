...
class Plugin:
    ...
    async def sync_now(self, winner: str, resync: bool) -> int | None:
        ...
        return GlobalSyncTarget().sync_now(winner, resync)
    ...
    async def signal(self, pid: int, s: str) -> None:
        ...
        process_utils.send_signal(pid, getattr(signal, s))
